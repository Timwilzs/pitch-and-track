...
<head>
	<meta charset="UTF-8">
	<title>PitchnTrack - Program</title>
	<!-- =================== META =================== -->
				...
				<nav class="nav-menu">
					<ul class="nav-list">
						<li class="dropdown">
							...
							<ul>
								<li><a href="index.php">Crossfit</a></li>
								<li><a href="home-fitness.php">Fitness</a></li>
								<li><a href="home-crossfit-lite.php">Crossfit Lite</a></li>
							</ul>
						</li>
