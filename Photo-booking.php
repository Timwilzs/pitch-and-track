...
<head>
	<meta charset="UTF-8">
	<title>PitchnTrack - Photo Booking</title>
	<!-- =================== META =================== -->
...
<body id="home" class="page-program">
	...
	<header class="header">
		...
		<section class="" style="background-image: url(assets/img/about-top-1.png);">


		<div class="header-menu">
			<div class="container">
				<div class="header-logo">
					<a href="index.php" class="logo"><img src="assets/img/#" alt="logo"><h3>Pitch<em>N</em>Track</h3></a>
				</div>
				<nav class="nav-menu">
					<ul class="nav-list">
	...
	<section class="s-contacts" style="background-color: #ffffff;">
		<div class="container">
			<h2 class="title-decor">Contact <span>Us</span> on Photography booking</h2>
			...
			<div class="row">
				...
				<div class="col-md-7 col-lg-8">
					<form action="photoinsert.php" method="POST"> 
						<ul class="form-cover">
							<li class="inp-name">
								<label>Name </label>
