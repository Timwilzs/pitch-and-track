...
<head>
	<meta charset="UTF-8">
	<title>PitchnTrack - Videography</title>
	<!-- =================== META =================== -->
...
<body id="home" class="page-trainer">
		...
		<div class="header-menu">
			<div class="container">
				<div class="header-logo">
					<a href="index-2.html" class="logo"><img src="assets/img/#.svg" alt="logo">
					<h3>Pitch<em>n</em>Track</a>
				</div>
				<nav class="nav-menu">
					<ul class="nav-list">
						...
						<li class="dropdown">
							...
							<ul>
								...
								<li class="menu-active"><a href="videography.php">Videography</a></li>
							</ul>
						</li>
	...
	<!-- =============== HEADER-TITLE =============== -->
	<section class="s-header-title" style="background-color: #ffffff;">
		<div class="container">
			<h1 class="title-decor"><span>Videography</span></h1>
		</div>
	</section>
	<!-- ============= HEADER-TITLE END ============= -->
	...
	<section class="s-contacts" style="background-image: url(assets/img/bg-contacts.svg);">
		<div class="container">
			<h2 class="title-decor"><span>Sign up</span></h2>
			...
			<div class="row">
				<div class="col-md-5 col-lg-4">
					...
					<div class="contact-item">
						...
						<div class="contact-item-right">
							<ul class="contact-item-list">
								<li><a href="mailto:Pitch<em>n</em>Trackteam@gmail.com">Pitch<em>n</em>Trackteam@gmail.com</a></li>
								<li><a href="mailto:Pitch<em>n</em>Trackhelp@gmail.com">Pitch<em>n</em>Trackhelp@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="contact-item">
				...
				<div class="col-md-7 col-lg-8">
					<form action="videographysignupinsert.php" method="POST">
						<ul class="form-cover">
							<li class="inp-name">
								<label>Surname</label>
								<input id="surname" type="text" name="surname" required="required" />
							</li>
							<li class="inp-name">
								<label>First Name</label>
								<input id="first name" type="text" name="firstname" required="required" />
							</li>	
							<li class="inp-name">
								<label>Last Name</label>
								<input id="last name" type="text" name="lastname" required="required" />
							</li>
							<li class="inp-email">
								<label>E-mail</label>
							...
							<li class="inp-number">
								...
								<input id="Phone-Number" type="text" name="number"  required="required" />
							</li>
							<li class="inp-address">
								<label>Address</label>
								<input id="Address" type="text" name="address"  required="required" />
							</li>
							<li class="inp-bank">
								<label>Bank-Account</label>
								<input id="Bank-Account" type="text" name="bank_account"  required="required" />
							</li>
						</ul>
