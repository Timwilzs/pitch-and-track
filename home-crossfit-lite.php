...
<head>
	<meta charset="UTF-8">
	<title>Fitmax - Crossfit Lite</title>
	<!-- =================== META =================== -->
...
<body id="home">
					...
					<ul class="nav-list">
						<li class="dropdown">
							...
							<ul>
								...
								<li class="menu-active"><a href="home-crossfit-lite.html">Crossfit Lite</a></li>
							</ul>
						</li>
						...
						<li class="dropdown">
							...
							<ul>
								<li><a href="program.html">Photography</a></li>
								<li><a href="trainer.html">Videography</a></li>
							</ul>
						</li>
	...
	<!--================ RELATED POSTS ================-->
	<section class="s-related-posts home-related-posts crossfit-lite-posts">
		<div class="container">
	...
	<!-- =========== S-TRAINING-SCHEDULE =========== -->
	<section class="s-training-schedule">
		<div class="container">
