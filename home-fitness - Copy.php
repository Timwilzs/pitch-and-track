...
<head>
	<meta charset="UTF-8">
	<title>Sport45 - Videography</title>
	<!-- =================== META =================== -->
	<meta name="keywords" content="">
	<meta name="description" content="">
	<meta name="format-detection" content="telephone=no">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<link rel="shortcut icon" href="assets/img/#.jpeg">
	<!-- =================== STYLE =================== -->
				...
				<div class="row top-panel-row">
					<div class="col-sm-4 top-panel-left">
						<ul class="header-cont">
							<li><i class="fa fa-map-marker" aria-hidden="true"></i><a href="contacts.html">Abuja Nigeria</a></li>
						</ul>
					</div>
		...
		<div class="header-menu">
			<div class="container">
				<div class="header-logo">
					<a href="index-2.html" class="logo"><img src="assets/img/LOGO.png" alt="logo"></a>
				</div>
				<nav class="nav-menu">
					<ul class="nav-list">
						<li class="dropdown">
							...
							<ul>
								<li class="menu-active"><a href="index-2.html">Pictures</a></li>
								<li><a href="home-fitness.html">Videography</a></li>
								<li><a href="home-crossfit-lite.html">Scouting</a></li>
							</ul>
						</li>
						...
						<li class="dropdown">
							...
							<ul>
								...
								<li><a href="trainer.html">Partner</a></li>
							</ul>
						</li>
		...
		<div class="fitness-slider">
			<div class="fitness-slide">
				...
				<div class="slide-img-cover">
					<div data-hover-only="true" class="scene">
						<img class="slide-img" data-depth="0.2" src="assets/img/woman1.png" alt="img">
					</div>
				</div>
				<div class="container">
			...
			<div class="fitness-slide">
				...
				<div class="slide-img-cover">
					<div data-hover-only="true" class="scene">
						<img class="slide-img" data-depth="0.2" src="assets/img/woman2.png" alt="img">
					</div>
				</div>
				<div class="container">
					<img class="slide-img-effect" src="assets/img/slider-square.svg" alt="img">
					...
					<div class="fitness-slide-cover">
						<h2 class="title">Stand <span>Out</span></h2>
					</div>
				</div>
			</div>
			<div class="fitness-slide">
				...
				<div class="slide-img-cover">
					<div data-hover-only="true" class="scene">
						<img class="slide-img" data-depth="0.2" src="assets/img/woman3.png" alt="img">
					</div>
				</div>
				<div class="container">
					<img class="slide-img-effect" src="assets/img/slider-square.svg" alt="img">
					...
					<div class="fitness-slide-cover">
						<h2 class="title">Build <span>Your Future</span></h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="welcome-fitness-row">
				...
				<div class="welcome-fitness-item">
					<div class="welcome-fitness-info">
						<h2 class="title-decor">Welcome To <span>Videography</span></h2>
						<p>Our Videographers and partners come together to bring out the best video coverages of our sportsmen and women, their incredible and sensational moments</p>
			...
			<div class="row">
				<div class="col-md-4 fitness-post-col">
					<div class="post-item-cover">
						...
						<div class="post-content">
							<h4 class="title"><a href="single-blog.html">Sed ut perspiciatis unde omnis</a></h4>
							<div class="text">
				...
				<div class="col-md-4 fitness-post-col">
					<div class="post-item-cover">
						...
						<div class="post-content">
							<h4 class="title"><a href="single-blog.html">Creating a WordPress Blog</a></h4>
							<div class="text">
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem…</p>
							</div>
						</div>
